...
while running:
    ...
    screen.fill((0, 0, 0))
    screen.blit(backLoop1, (0, -800))
    screen.blit(backLoop2, (0, 0))
    screen.blit(moon, (0, 0))

    # Applies gravity to the players movement value if the ship isn't at max speed or if the ships isn't at the bottom of the screen.
